    ...
    function Modal(props, ref) {
        return(
            <dialog ref={ref} className="rounded-lg py-6 px-4 backdrop:backdrop-blur-sm backdrop:backdrop-brightness-50 shadow-2xl">
                ...
                <div className="flex flex-row-reverse"><button className="border-transparent bg-stone-700 px-4 py-2 rounded-md text-stone-400 hover:bg-stone-600 hover:text-stone-100" onClick={props.closeModal}>Okay</button></div>
            </dialog>
        );
    }
);
